...
// this file must only ever be reached (via the lazy wrapper in `infinite-canvas.tsx`) after
// CanvasKit has already finished loading. See the identical note in slide-canvas-impl.tsx.
...
// Default export so this module can be `React.lazy`-loaded (see infinite-canvas.tsx).
